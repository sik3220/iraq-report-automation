...
- 개인 피습·영사 지원, 소수 인원 체포 같은 단발성 지역 치안, 직능단체 면담,
  시설 개관·의전 행사는 정책 변화나 전략적 파급효과가 명확하지 않으면 제외
- 같은 사건을 다룬 기사가 이미 대표 기사로 처리됐다면 중복 기사는 제외
- 테스트·예제 데이터는 제외
...
11. 인물명은 영문 성 + 한국어 직책. 아랍계 인물의 성은 회사 표기에 따라 Al- 접두사를 유지한다
    (예: Al-Halbousi 국회의장, Al-Maliki 전 총리, Al-Sudani 전 총리). 직책은 한 번만 쓰고 기사에 없는 직책은 만들지 않는다
